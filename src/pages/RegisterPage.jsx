    ...
    <div className="mx-auto max-w-3xl rounded-[2rem] bg-white/95 p-10 shadow-soft">
      ...
      {awaitingConfirmation ? (
        <div className="mt-10 space-y-5">
          ...
          <p className="text-slate-600">We sent a confirmation link to <span className="font-medium">{createdEmail}</span>. Open the email and follow the link to confirm your account, then sign in.</p>
          <div>
            <Link to="/login" className="inline-flex items-center justify-center rounded-full bg-night px-8 py-4 text-sm font-semibold text-white transition hover:bg-slate-900">Sign in</Link>
          </div>
        </div>
      ) : (
